...
const MainPage = () => {
  ...
  return (
    <div className="w-full min-h-screen flex-col-center gap-50 bg-primary-0">
      ...
      <div className="flex-row-center invisible opacity-0 peer-hover:visible peer-hover:opacity-100 transition-all duration-300 w-1064 h-245 bg-white rounded-20 gap-277 mb-50">
